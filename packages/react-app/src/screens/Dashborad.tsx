...
export default function Dashboard() {
    ...
    const receivers = trustersData?.data?.member?.trusters?.length || 0;
                    ...
                    <div className="relative">
                        <svg className="w-28 h-28 transform -rotate-90" viewBox="0 0 120 120">
                            ...
                            <circle
                                ...
                                strokeDashoffset={`${2 * Math.PI * 50 * (1 - Math.min((supporters + receivers) / 20, 1))}`}
                                className={netFlowRate >= 0n ? "text-green-500" : "text-red-500"}
                                strokeLinecap="round"
                            />
                        </svg>
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <p className={`text-lg font-bold ${netFlowRate >= 0n ? "text-green-400" : "text-red-400"}`}>
                                {balance || "0"}
                            </p>
                ...
                <div className="bg-gray-900 rounded-xl p-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center border-t border-gray-800 pt-3">
                            ...
                            <span className={`font-medium ${netFlowRate >= 0n ? "text-green-400" : "text-red-400"}`}>
                                {netFlowRate !== 0n
